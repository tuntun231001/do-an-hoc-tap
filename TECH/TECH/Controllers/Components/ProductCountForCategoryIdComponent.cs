...
{
    [ViewComponent(Name = "ProductCountForCategoryIdComponent")]
    public class ProductCountForCategoryIdComponent : ViewComponent
    {
        private readonly ICategoryService _categoryService;
        private readonly IProductsService _productService;
        public ProductCountForCategoryIdComponent(ICategoryService categoryService,
